  ...
  return (
    <main className="bg-[#FDFBF7]">
      <div className="max-w-4xl mx-auto px-4 py-20">
        <h1 className="font-serif text-4xl sm:text-5xl text-[#2C2C2C] mb-12 text-center">
          My Journey
        </h1>
        ...
        <div className="mt-16 pt-8 border-t border-[#D4A574]/20">
          <h2 className="font-serif text-2xl text-[#2C2C2C] mb-4">Get in Touch</h2>
          <p className="text-[#4a4a4a] mb-4">
            Interested in a piece or commissioning custom work?
          </p>
          <a
            href="mailto:hello@spilledpalettestudio.com"
            className="text-[#D4A574] hover:border-b-2 hover:border-[#D4A574] transition-all font-medium inline-block pb-1"
          >

      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <button 
            ...
            className="w-full bg-[#D4A574] text-white py-4 rounded-full text-base font-medium hover:bg-[#2C2C2C] transition-all shadow-lg active:scale-[0.98]"
          >
            Buy Physical Print — ${artwork.price}
          </button>
          <p className="text-center mt-3 text-xs text-[#2C2C2C]/40 uppercase tracking-widest">
            Ships Worldwide • Prodigi Fulfillment
          </p>
        </div>
      </div>
